...
pub fn draw_panel(
    ...
    let (l, t, r, b) = (ns.left as f32, ns.top as f32, ns.right as f32, ns.bottom as f32);
    ...
    // Row 0: TL, TC, TR
    batch.draw_sprite(tex_id, [0.0, 0.0, l, t], [dx, dy, l, t], tex_size, false, white);
    batch.draw_sprite(tex_id, [l, 0.0, cw, t], [dx + l, dy, dst_cw, t], tex_size, false, white);
    batch.draw_sprite(tex_id, [l + cw, 0.0, r, t], [dx + l + dst_cw, dy, r, t], tex_size, false, white);

    // Row 1: ML, MC, MR
    batch.draw_sprite(tex_id, [0.0, t, l, ch], [dx, dy + t, l, dst_ch], tex_size, false, white);
    batch.draw_sprite(tex_id, [l, t, cw, ch], [dx + l, dy + t, dst_cw, dst_ch], tex_size, false, white);
    batch.draw_sprite(tex_id, [l + cw, t, r, ch], [dx + l + dst_cw, dy + t, r, dst_ch], tex_size, false, white);

    // Row 2: BL, BC, BR
    batch.draw_sprite(tex_id, [0.0, t + ch, l, b], [dx, dy + t + dst_ch, l, b], tex_size, false, white);
    batch.draw_sprite(tex_id, [l, t + ch, cw, b], [dx + l, dy + t + dst_ch, dst_cw, b], tex_size, false, white);
    batch.draw_sprite(tex_id, [l + cw, t + ch, r, b], [dx + l + dst_cw, dy + t + dst_ch, r, b], tex_size, false, white);
}
...
pub fn draw_bar_3slice(
    ...
    batch.draw_sprite(tex_id, [0.0, 0.0, cap_w, ah], [dx, dy, cap_w, dh], tex_size, false, white);
    batch.draw_sprite(tex_id, [cap_w, 0.0, center_w, ah], [dx + cap_w, dy, dst_center, dh], tex_size, false, white);
    batch.draw_sprite(tex_id, [cap_w + center_w, 0.0, cap_w, ah], [dx + cap_w + dst_center, dy, cap_w, dh], tex_size, false, white);
}
...
pub fn draw_small_ribbon(
    ...
    batch.draw_sprite(tex_id, [lx, ly, lw, lh], [start_x, start_y, draw_lw, draw_h], tex_size, false, white);
    batch.draw_sprite(tex_id, [mx, my, mw, mh], [start_x + draw_lw, start_y, draw_cw, draw_h], tex_size, false, white);
    batch.draw_sprite(tex_id, [rx, ry, rw, rh], [start_x + draw_lw + draw_cw, start_y, draw_rw, draw_h], tex_size, false, white);
}
