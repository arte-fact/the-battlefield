...
impl Game {
    ...
    fn ai_order_go_tick(&mut self, ai_idx: usize, target_x: f32, target_y: f32, dt: f32) {
        let ai_id = self.units[ai_idx].id;
    ...
    fn ai_order_retreat_tick(&mut self, ai_idx: usize, target_x: f32, target_y: f32, dt: f32) {
        let ai_id = self.units[ai_idx].id;
    ...
    fn ai_order_follow_tick(&mut self, ai_idx: usize, dt: f32) {
        let ai_id = self.units[ai_idx].id;
